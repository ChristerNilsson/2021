...
class Justering:
    ...
    def justera_konstant(self,enkelbiljettyp,biljetter,pristak_UA): #19
        ...
        self.resandedata.loc[self.resandedata['Antal_resor_per_manad'] < pristak_frek,asc] += ((1-pristak_kvot)*r-self.resandedata.loc[self.resandedata['Antal_resor_per_manad'] < pristak_frek,asc])*((1.0*self.resandedata.loc[self.resandedata['Antal_resor_per_manad'] < pristak_frek,'Antal_resor_per_manad']/pristak_frek)**s)
        self.resandedata.loc[self.resandedata['Antal_resor_per_manad'] >= pristak_frek,asc] = (1-pristak_kvot)*r
